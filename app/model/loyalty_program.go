...
type LoyaltyProgramAPI struct {
	...
	LoyaltyStart                     *strfmt.DateTime `json:"loyalty_start,omitempty" gorm:"type:timestamp" format:"date-time" swaggertype:"string"`
	LoyaltyEnd                       *strfmt.DateTime `json:"loyalty_end,omitempty" gorm:"type:timestamp" format:"date-time" swaggertype:"string"`
