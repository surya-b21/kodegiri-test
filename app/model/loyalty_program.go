...
type LoyaltyProgramAPI struct {
	...
	LoyaltyStart                     *strfmt.DateTime `json:"loyalty_start,omitempty" gorm:"type:timestamp" swaggertype:"string"`
	LoyaltyEnd                       *strfmt.DateTime `json:"loyalty_end,omitempty" gorm:"type:timestamp" swaggertype:"string"`
